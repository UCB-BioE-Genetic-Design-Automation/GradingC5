...
public class FinalGrader {
    ...
    private void populateRubric() throws Exception {
        ...
        String keytext = FileUtils.readFile("/Users/jca20n/Dropbox (Personal)/Courses/134/Grading/final_key.txt");
    ...
    private void populateExamAnswers() throws Exception {
        ...
        String examstext = FileUtils.readFile("/Users/jca20n/Dropbox (Personal)/Courses/134/Grading/final_answers.txt");
    ...
    public void run() throws Exception {
        ...
        FileUtils.writeFile(gradebook.toString(), "BioE134-2017-final.txt");

        //Collect statistics
        StringBuilder report = collectStatistics();
        FileUtils.writeFile(report.toString(), "BioE134-2017-final-stats.txt");
    }
...
//                double rounded = Math.round(percentage*100)/100;
    ...
    public static void main(String[] args) throws Exception {
        FinalGrader grader = new FinalGrader();
        grader.initiate();
        grader.run();
    }
