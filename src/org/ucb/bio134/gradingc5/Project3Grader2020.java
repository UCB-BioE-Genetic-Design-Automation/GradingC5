 ...
 */
public class Project3Grader2020 {
    ...
    public void run() throws Exception {
        ...
        FileUtils.writeFile(sb.toString(), "Project3Results2020.txt");
    }
    ...
    private static String readResourceFile(String relPath) throws Exception {
        URL url = new Project3Grader2020().getClass().getResource(relPath);
    ...
    public static void main(String[] args) throws Exception {
        Project3Grader2020 grader = new Project3Grader2020();
        grader.initiate();
